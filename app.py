...
print("Độ chính xác của mô hình: ", accuracy_svm)
...
def index():
    ...
    if request.method == 'POST':
        ...
        if selected_model == 'svm':
            ...
            prediction = gaussian_nb_model.predict(input_tfidf_dense)
        
        result = prediction[0]
    
    return render_template('index.html', accuracy_svm=accuracy_svm, accuracy_logistic=accuracy_logistic, accuracy_nb=accuracy_nb, result=result, selected_model=selected_model)
